...
from basemodel.onnx_base_model import OnnxBaseModel
from utils.utils import Args

current_dir = os.path.dirname(os.path.abspath(__file__))
project_root = os.path.dirname(current_dir)
models_dir = os.path.join(project_root, 'models/groundingdino_swint_ogc_quant.onnx')
config_dir = os.path.join(project_root, 'services/configs/groundingdino.yaml')
...
class ObjectDetectionServices:
    ...
    def get_tokenlizer(text_encoder_type):
        ...
        cfg_file = os.path.join(project_root, "services", "configs", cfg_name)
