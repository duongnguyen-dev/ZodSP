...
4. [Continuous deployment to GKE using Jenkins pipeline](#4-continuous-deployment-to-gke-using-jenkins-pipeline)
    1. [Create Google Compute Engine](#41-create-google-compute-engine)
    2. [Install Docker and Jenkins in GCE](#42-install-docker-and-jenkins-in-gce)
    3. [Connect to Jenkins UI in GCE](#43-connect-to-jenkins-ui-in-gce)
